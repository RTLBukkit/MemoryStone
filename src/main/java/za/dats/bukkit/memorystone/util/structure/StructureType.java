...
/**
 * An immutable type representing a type of structure. This is basically used as
 * a pattern to search for. It has some protected methods used by Structure.
 * 
 * @author tim
 */
public class StructureType {
	...
	public StructureType(Prototype proto) {
		...
		// we don't need to make new lists, because the are never public up to
		// now

 ...
 */
public enum Rotator {
	NONE(Arrays.asList(new BlockOffset(0, 0, 0))), Y_ONLY(Arrays.asList(new BlockOffset(0, 0, 0), new BlockOffset(0, 1, 0),
			new BlockOffset(0, 2, 0), new BlockOffset(0, 3, 0))), ALL(Arrays.asList(new BlockOffset(0, 0, 0), new BlockOffset(0, 0, 1),
			new BlockOffset(0, 0, 2), new BlockOffset(0, 0, 3), new BlockOffset(0, 1, 0), new BlockOffset(0, 1, 1),
			new BlockOffset(0, 1, 2), new BlockOffset(0, 1, 3), new BlockOffset(0, 2, 0), new BlockOffset(0, 2, 1),
			new BlockOffset(0, 2, 2), new BlockOffset(0, 2, 3), new BlockOffset(0, 3, 0), new BlockOffset(0, 3, 1),
			new BlockOffset(0, 3, 2), new BlockOffset(0, 3, 3), new BlockOffset(1, 0, 0), new BlockOffset(1, 0, 1),
			new BlockOffset(1, 0, 2), new BlockOffset(1, 0, 3), new BlockOffset(1, 2, 0), new BlockOffset(1, 2, 1),
			new BlockOffset(1, 2, 2), new BlockOffset(1, 2, 3)));
	 ...
	 * 
	 * @param name
	 *            The rotator's name (in the enum).
	...
	public List<BlockOffset> getRotated(BlockOffset offset) {
		...
		for (BlockOffset rotcount : this.rotlist) {
			rotoffsets.add(this.rotateXYZ(offset, rotcount.x, rotcount.y, rotcount.z));
		}
	 ...
	 * BlockVector about the X, Y, and Z axes. This method should be pretty
	 * quick because it's just a bunch of assignments.
	 * 
	 * This is equal to: R = Rz * Ry * Rx, bo_new = R * bo
	 * 
	 * @param xcount
	 *            The number of pi/2 rotations about the x axis.
	 * @param ycount
	 *            The number of pi/2 rotations about the y axis.
	 * @param zcount
	 *            The number of pi/2 rotations about the z axis.

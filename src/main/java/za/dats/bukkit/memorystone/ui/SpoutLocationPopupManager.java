...
public class SpoutLocationPopupManager {
	...
	// Map<UUID, MemoryStone> locationButtons = new HashMap<UUID,
	// MemoryStone>();
	// GenericPopup popup;
	// UUID cancelId;
	// UUID nextId;
	...
	//
	// String pageText = "" + (page + 1) + " / " + (((locations.size() - 1) /
	// PAGE_SIZE) + 1);
	...
	// locationButton
	// .setX(center - (widthScale * (buttonWidth + 5)) + (widthScale * col *
	// (buttonWidth + 10)))
	// .setY(heightScale * (row + 2) * 13);
	// locationButton.setWidth(widthScale * buttonWidth).setHeight(heightScale *
	// 10);
	...
	// }
	//
	// void createPopup(SpoutPlayer sPlayer, Set<MemoryStone> locationSet,
	// String text, LocationPopupListener listener) {
	...
	// private HashMap<UUID, LocationPopup> popups = new HashMap<UUID,
	// SpoutLocationPopupManager.LocationPopup>();
	// private HashMap<String, LocationPopup> playerPopups = new HashMap<String,
	// SpoutLocationPopupManager.LocationPopup>();
	//
	...
	// plugin.getServer().getPluginManager().registerEvent(Type.CUSTOM_EVENT,
	// this, Priority.Normal, plugin);
	// }
	//
	// public void showPopup(Player player, Set<MemoryStone> locations, String
	// text, LocationPopupListener listener) {

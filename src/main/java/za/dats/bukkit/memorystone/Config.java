...
public class Config {
	...
	public enum MemoryEffect {
		LIGHTNING_ON_CREATE("effects.lightningOnCreate"), LIGHTNING_ON_BREAK("effects.lightningOnBreak"), LIGHTNING_ON_TELEPORT_SOURCE(
				"effects.lightningOnTeleportSource"), LIGHTNING_ON_TELEPORT_DEST("effects.lightningOnTeleportDestination");
	...
	private static boolean setDefaults() {
		...
		// not used yet. needs thinking about how to use this message without
		// spamming
